...
$sql = "SELECT id, nameWorry, nameWorryEng FROM basic_worry ";
$stmt = $conn->query($sql);
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <h2 class="head-topic text-primary pb-3">Manage Basic Worry/จัดการความกังวล เบื้องต้น</h2>
                    <hr class="p-md-2">
                    <!--  Row 1 -->
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 overflow-hidden">
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <h4 class="fs- mb-1 card-title text-primary me-2">ค้นหาจากความกังวล เบื้องต้น</h4>
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <input type="text" id="searchInput" class="form-control w-20 me-2"
                                        placeholder="ชื่อความกังวล เบื้องต้น">
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#addBasicWorryModal">
                                        Add Basic Worry +
                                    </button>
                                </div>
                                <hr>
                                    ...
                                    <div id="searchResult" class="table-responsive products-tabel" data-simplebar>
                                        <table class="table text-nowrap mb-0 align-middle table-hover">
                                            <thead class="fs-4">
                                                <tr>
                                                    <th class="fs-3">No</th>
                                                    <th class="fs-3">nameWorry</th>
                                                    <th class="fs-3">nameWorryEng</th>
                                                ...
                                                if ($result): ?>
                                                    <?php foreach ($result as $row): ?>
                                                        <tr>
                                                            ...
                                                            <td><?= htmlspecialchars($row['nameWorryEng']); ?></td>
                                                            <td>
        ...
        <?php include 'modal/modal_manage_basic_worry.php'; ?>
    </div>
    ...
    <script src="../assets/js/add/add_basic_worry.js"></script>
    <script src="../assets/js/edit/edit_manage_basic_worry.js"></script>
    <script src="../assets/js/delete/delete_manage_basic_worry.js"></script>
</body>
</html>