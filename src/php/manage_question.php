...
$sql = "SELECT q.id, q.question, f.nameType AS nameType, q.question_type 
        FROM question q 
        LEFT JOIN form_type f ON q.formtype_id = f.id";
$stmt = $conn->query($sql);
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <h2 class="head-topic text-primary pb-3">Manage Question/จัดการคำถาม</h2>
                    <hr class="p-md-2">
                    <!--  Row 1 -->
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 overflow-hidden">
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <h4 class="fs- mb-1 card-title text-primary me-2">ค้นหาจากประเภทคำถาม</h4>
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    ...
                                    <div id="searchResult" class="table-responsive products-tabel" data-simplebar>
                                        <table class="table text-nowrap mb-0 align-middle table-hover">
                                            <thead class="fs-4">
                                                <tr>
                                                    <th class="fs-3">No</th>
                                                    <th class="fs-3">question</th>
                                                    <th class="fs-3">formtype_id</th>
                                                    <th class="fs-3">question_type</th>
        ...
        <?php include 'modal/modal_manage_question.php'; ?>
    </div>
    ...
    <script src="../assets/js/add/add_question.js"></script>
    <script src="../assets/js/edit/edit_manage_question.js"></script>
    <script src="../assets/js/delete/delete_manage_question.js"></script>
</body>
</html>