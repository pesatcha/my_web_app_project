...
$sql = "SELECT o.id, o.option_name, f.nameType AS nameType, o.score 
        FROM option o 
        LEFT JOIN form_type f ON o.formtype_id = f.id";
$stmt = $conn->query($sql);
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <h2 class="head-topic text-primary pb-3">Set Score/เซ็ตคะแนน</h2>
                    <hr class="p-md-2">
                    <!--  Row 1 -->
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 overflow-hidden">
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <h4 class="fs- mb-1 card-title text-primary me-2">ค้นหาเซ็ตคะแนน</h4>
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <input type="text" id="searchInput" class="form-control w-20 me-2"
                                        placeholder="ชื่อคะแนน">
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
        ...
        <?php include 'modal/modal_manage_option.php'; ?>
    </div>
    ...
    <script src="../assets/js/add/add_option.js"></script>
    <script src="../assets/js/edit/edit_manage_option.js"></script>
    <script src="../assets/js/delete/delete_manage_option.js"></script>
</body>
</html>