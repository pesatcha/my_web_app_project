...
$sql = "SELECT g.id, g.guidance, f.nameType AS nameType FROM guidance g 
        LEFT JOIN form_type f ON g.formtype_id = f.id";
$stmt = $conn->query($sql);
...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <h2 class="head-topic text-primary pb-3">Manage Guidance/จัดการคำแนะนำ</h2>
                    <hr class="p-md-2">
                    <!--  Row 1 -->
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-stretch">
                            <div class="card w-100 overflow-hidden">
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <h4 class="fs- mb-1 card-title text-primary me-2">ค้นหาจากประเภทคำแนะนำ</h4>
                                </div>
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                ...
                                <div class="card-body py-1 d-flex align-items-center justify-content-end mb-1">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#addGuidanceModal">
                                        Add Guidance +
                                    </button>
                                </div>
                                <hr>
                                                ...
                                                if ($result): ?>
                                                    <?php foreach ($result as $row): ?>
                                                        <tr>
                                                            ...
                                                            <td><?= htmlspecialchars($row['guidance']); ?></td>
        ...
        <?php include 'modal/modal_manage_guidance.php'; ?>
    </div>
    ...
    <script src="../assets/js/add/add_guidance.js"></script>
    <script src="../assets/js/edit/edit_manage_guidance.js"></script>
    <script src="../assets/js/delete/delete_manage_guidance.js"></script>
</body>
</html>